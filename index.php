...
//print_r($rootFiles); print_r($subdirectoryFiles);

$allFiles = array_merge(glob(UP_PLUGIN_DIR . 'includes/*.php'), glob(UP_PLUGIN_DIR . 'includes/**/*.php'));
...
add_action( 'init', 'up_register_post_type' );
...
add_action( 'wp_enqueue_scripts', 'up_load_block_translations', 1000 );